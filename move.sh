...
do
 ...
 do
   ...
   then
      ...
      sudo rclone move /mnt/disk1/ dropbox:plots/ --progress --drive-stop-on-upload-limit --drive-stop-on-download-limit --include "*.plot" --log-level ERROR --log-file=/root/.config/rclone/dropbox.log 
      echo
      echo "OK!"
      date >> OK
   fi
